...
###############################################################################
parser.add_argument('--tag', default='building_Vaihingen_FlipCAM_resnet50_RGB_alpha=0.25', type=str)
...
if __name__ == '__main__':
    ...
    if 'ALL' in args.domain:
        experiment_name += '@train+val'
    elif 'val' in args.domain:
        experiment_name += '@val'
    elif 'test' in args.domain:
    ...
    # state_dict = torch.load(r'D:\WSSS_code\PuzzleCAM-master\experiments\building_test2_resnet50_baseCAM\models\building_test2_resnet50_baseCAM_fg.pth')


    model_path = f'./experiments/{args.tag}/models/{args.tag}_fg.pth'
    # model_path = f'./experiments/{args.tag}/models/150.pth'
